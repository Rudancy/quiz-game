...
def ask_questions():
    ...
    with open("questions.txt", "r") as file: # with - no need to close at the end of block
    ...
    #zip puts two tuples together see example below
    #https://www.w3schools.com/python/showpython.asp?filename=demo_ref_zip2
